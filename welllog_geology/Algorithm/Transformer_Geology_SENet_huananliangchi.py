...
patch_height = 33
patch_size = patch_height * features_num
...
def Net():
    return make_model(patch_size, label_num, d_model=512, patch_height=patch_height)
...
class EncoderDecoder(nn.Module):
    ...
    def __init__(self, encoder, decoder, src_embed, tgt_embed, generator, patch_height):
        """
        生成编码解码器
        :param encoder: 是个函数
        :param decoder: 是个函数
...
def make_model(h_in, tgt_vocab, n=6, d_model=512, d_ff=2048, h=8, dropout=0.1, patch_height=patch_height):
