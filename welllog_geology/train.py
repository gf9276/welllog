...
def parse_args():
    ...
    # 模型配置文件
    parser.add_argument('--config', default="Transformer_Geology_SENet", help='模型的名字')
    # 文件和路径相关
    parser.add_argument('--logging_filepath', default="./Log/Train/Transformer_Geology_SENet_33_5/logging.json", help='日志文件路径')
    parser.add_argument('--model_save_path', default="./Log/Train/Transformer_Geology_SENet_33_5/output.pth", help='模型文件保存路径')
    parser.add_argument('--train_filepath', default="Data/定边/定边预探井130_全井段_地质分层20230725/train.h5", help='训练集路径')
    parser.add_argument('--val_filepath', default="Data/定边/定边预探井5_全井段_地质分层20230725/test.h5", help='验证集路径')
    # 一些开关
    parser.add_argument('--pretrained', default="False", help='是否要预训练')
    parser.add_argument('--checkpoint', default='Log/Train/Transformer_Geology_SENet_33/output.pth', help='模型权重路径')
